...
Tudo foi feito **reaproveitando apenas técnicas que já aparecem nos códigos das aulas**
(pasta `Computacao_Grafica`):
...
| Desenho do cone com `glutWireCone(base, altura, slices, stacks)` | `Cap4/Objects.cpp` |
...
- **+** classe `Cone`, `vector<Cone> cones`, `drawCones()`.
